...
export default function Clubs() {
    ...
    return (
        ...
        <h1 className="text-5xl font-bold text-center mt-10">BIF Computer Science Club</h1> 
        ...
        <div class="grid columns-1 space-y-3 justify-center">
            ...
            <a  class="justify-center block max-w-3xl px-6 py-3 bg-white border border-gray-200 rounded-3xl shadow-md hover:opacity-75 bg-gradient-to-tr from-teal-100 to-purple-100">
