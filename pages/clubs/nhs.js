...
export default function Clubs() {
    ...
    return (
        ...
        <h1 className="text-5xl font-bold text-center mt-10">BIF National Honors Society</h1> 
        <h1 className="text-3xl font-medium text-center mt-2 text-gray-600">Photos</h1> 
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 ">
        
        <h2 className="sr-only">National Honors Society</h2>
