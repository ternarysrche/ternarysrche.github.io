              ...
              <div className="isolate bg-white h-screen place-content-center justify-center items-center">
                  ...
                  <div className = "grid place-items-center">
                    ...
                    <div className = "grid grid-cols-3 gap-x-3">
                        <a href = "https://clear-closet.vercel.app/" className = "text-3xl py-2 hover:opacity-50 text-black"><FiLink /></a>
                        <a href = "https://github.com/maggie-j-liu/closet-app" className = "text-3xl py-2 hover:opacity-50 text-black"><SiGithub /></a>
                        <a href = "https://devpost.com/software/clear-closet" className = "text-3xl py-2 hover:opacity-50 text-black" ><SiDevpost /></a></div>
