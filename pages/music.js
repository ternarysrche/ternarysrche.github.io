...
export default function Clubs() {
    ...
    return (
        ...
        <h1 className="text-4xl font-medium text-center mt-5 text-gray-700">Covers</h1> 
            ...
            <div className = "mx-auto">
            <audio controls>
            <source src="/music/closure.m4a" type="audio/x-m4a"/>
            Your browser does not support the audio tag.
            </audio>
            </div>
        ...
        <h1 className="mt-10 text-4xl font-medium text-center mt-5 text-gray-700">Covers - Acapella</h1> 
            ...
            <br/><br/><br/>
            <h1 className="text-4xl font-medium text-center mt-5 text-gray-700">Video Performances</h1> 
